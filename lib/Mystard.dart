...
class MyMustard extends StatefulWidget {
  const MyMustard({super.key});

  @override
  State<MyMustard> createState() => _MyMustardState();
}

class _MyMustardState extends State<MyMustard> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Mustard",style: TextStyle(fontSize: 30,color: Colors.black),),
        centerTitle: true,
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                    ...
                    child: Image(image: AssetImage("assets/mustard.jpg"))),
              ),
