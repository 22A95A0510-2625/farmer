...
class MyBanana extends StatefulWidget {
  const MyBanana({super.key});

  @override
  State<MyBanana> createState() => _MyBananaState();
}

class _MyBananaState extends State<MyBanana> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Banana",style: TextStyle(fontSize: 30,color: Colors.black),),
        centerTitle: true,
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                    ...
                    child: Image(image: AssetImage("assets/banana.jpg"))),
              ),
