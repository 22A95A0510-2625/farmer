...
class MyCapsicum extends StatefulWidget {
  const MyCapsicum({super.key});

  @override
  State<MyCapsicum> createState() => _MyCapsicumState();
}

class _MyCapsicumState extends State<MyCapsicum> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Capsicum",style: TextStyle(fontSize: 30,color: Colors.black),),
        centerTitle: true,
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                    ...
                    child: Image(image: AssetImage("assets/capsicum.jpg"))),
              ),
