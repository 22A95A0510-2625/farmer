...
class MyMangoes extends StatefulWidget {
  const MyMangoes({super.key});

  @override
  State<MyMangoes> createState() => _MyMangoesState();
}

class _MyMangoesState extends State<MyMangoes> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Mangoes",style: TextStyle(fontSize: 30,color: Colors.black),),
        centerTitle: true,
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                    ...
                    child: Image(image: AssetImage("assets/mangoes.jpg"))),
              ),
